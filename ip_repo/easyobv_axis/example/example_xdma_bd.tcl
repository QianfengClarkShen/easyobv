...
proc create_root_design { parentCell INSTR_BYTES easyobv_config} {
  ...
  connect_bd_net -net processor_pl_clk0 [get_bd_pins easyobv_axis_0/s_axil_aclk] [get_bd_pins memory/pcie_clk] [get_bd_pins traffic_engine_0/s_axil_aclk] [get_bd_pins xdma/axi_aclk]
